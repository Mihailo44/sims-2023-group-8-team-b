...
{
    public class PostponementRequestApprovalDialogueViewModel : PostponementRequestDialogueViewModel, ICloseable
    {
        ...
        {
            CurrentVM = new PostponementRequestCommentDialogueViewModel(SelectedRequest,_window);
        }
    }
}
